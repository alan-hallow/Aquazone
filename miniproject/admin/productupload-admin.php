...
<body>
    ...
    <a href="productstable-admin.php" class="allproductsbtntext">
        <div class="allproductsbutton">All Products</div>
    </a>
    </div>
    ...
    <div class="container">
        ...
        <form id="form" class="form" action="includes/productupload-inc.php" method="post" name="addproduct" enctype="multipart/form-data">
            ...
            <div class="form-control">
                ...
                <input type="number" name="price" placeholder="$999" id="postal" max="100000" min="0" />
            </div>
